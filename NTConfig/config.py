...
PermissionOption = {
    ...
    'CVote1Status': {'Condition': "CheckVoteStatus('Comment',1,request)", 'True': 'is-active', 'False': ''},
    'CVote0Status': {'Condition': "CheckVoteStatus('Comment',0,request)", 'True': 'is-active', 'False': ''},
